...
serve(async (req) => {
  ...
  try {
    ...
    if (hasActiveSub) {
      ...
      if (priceId === 'price_1SScT85d5AuxGTtPEyWiYHSB') {
        subscriptionType = 'monthly';
      } else if (priceId === 'price_1SScTO5d5AuxGTtP2DzspPES') {
        subscriptionType = 'annual';
      }
      
      logStep("Determined subscription tier", { productId, subscriptionType });
